...
void ifor_drone::set_mission(int repeat)
{
 ...
 /*   
    ...
    for(int l=0;l<17;l++)
    {
        ...
        mission_pos_arr[l].pose.position.z = 2;
        mission_pos_arr[l].pose.position.x = m;
        mission_pos_arr[l].pose.position.y = n;
        if(m<4)
        {
            m++;
        }
...
{
    ros::init(argc, argv, "ifor_offboard_node");
